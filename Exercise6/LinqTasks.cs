...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (emp, dept) => 
                new { emp.Ename, emp.Job, dept.Dname }
            );
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps
                .Join(Depts, e => e.Deptno, d => d.Deptno, (emp, dept) => new { emp, dept })
                .GroupBy(d => d.dept.Dname)
                .Where(g => g.Count() > 1)
                .Select(d => new
                {
                    name = d.Key,
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result =  Depts
                .Where(d => Emps.Count(e => e.Deptno == d.Deptno) == 5 || 
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            var managers = emps.Where(e => emps.Any(sub => sub.Mgr != null && sub.Mgr.Empno == e.Empno));

            var result = managers
                .OrderBy(e => (e.Ename, -e.Salary));
